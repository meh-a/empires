...
function startRoam(v) {
  ...
  // BFS from villager's current tile to collect only genuinely reachable open tiles.
  // Random sampling fails when 65% tree density disconnects open tiles into islands.
  {
